...
namespace PADController
{
    ...
    public sealed partial class Scenario2_LEDTemp : Page, IDisposable
    {
        ...
        {
            if (EventHandlerForDevice.controllerEventHandler != null && EventHandlerForDevice.controllerEventHandler.Device == null || EventHandlerForDevice.motorEventHandler != null && EventHandlerForDevice.motorEventHandler.Device == null)
            {
                LEDTempScrollViewer.Visibility = Visibility.Collapsed;
                MainPage.Current.NotifyUser("No device connected", NotifyType.ErrorMessage);
            }
            else
            {
                MainPage.Current.NotifyUser("Connected to " + EventHandlerForDevice.controllerEventHandler.DeviceInformation.Id,
        ...
        private void LED3Switch_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            {
                WriteControllerLedCommand("3", LedState.LedStateOn);
            }
            else
            {
                WriteControllerLedCommand("3", LedState.LedStateOff);
            }
        }
        ...
        private void LED4Switch_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            {
                WriteControllerLedCommand("4", LedState.LedStateOn);
            }
            else
            {
                WriteControllerLedCommand("4", LedState.LedStateOff);
            }
        }
        ...
        private void LED5Switch_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            {
                WriteControllerLedCommand("5", LedState.LedStateOn);
            }
            else
            {
                WriteControllerLedCommand("5", LedState.LedStateOff);
            }
        }
        ...
        private void LED6Switch_Toggled(object sender, RoutedEventArgs e)
        {
            ...
            {
                WriteControllerLedCommand("6", LedState.LedStateOn);
            }
            else
            {
                WriteControllerLedCommand("6", LedState.LedStateOff);
            }
        }
        ...
        private async void WriteControllerLedCommand(String ledNumber, LedState ledState)
        {
            if (EventHandlerForDevice.controllerEventHandler.IsDeviceConnected)
            {
                try
                {
                    rootPage.NotifyUser("Writing...", NotifyType.StatusMessage);

                    DataWriterObject = new DataWriter(EventHandlerForDevice.controllerEventHandler.Device.OutputStream);
        ...
        /// </summary>
        private async void TemperatureControllerButton_Click(object sender, RoutedEventArgs e)
        {
            if (EventHandlerForDevice.controllerEventHandler.IsDeviceConnected)
            {
                try
                ...
                try
                {
                    ...
                    DataReaderObject = new DataReader(EventHandlerForDevice.controllerEventHandler.Device.InputStream);
