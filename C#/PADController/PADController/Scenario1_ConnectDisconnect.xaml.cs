...
namespace PADController
{
    ...
    public sealed partial class Scenario1_ConnectDisconnect : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs eventArgs)
        {
            ...
            //if ((EventHandlerForDevice.controllerEventHandler != null
            //    && (EventHandlerForDevice.controllerEventHandler.IsDeviceConnected
            //    || (EventHandlerForDevice.controllerEventHandler.IsEnabledAutoReconnect
            //    && EventHandlerForDevice.controllerEventHandler.DeviceInformation != null))) &&
            //    EventHandlerForDevice.motorEventHandler != null
            //    && (EventHandlerForDevice.motorEventHandler.IsDeviceConnected
            //    || (EventHandlerForDevice.motorEventHandler.IsEnabledAutoReconnect
            //    && EventHandlerForDevice.motorEventHandler.DeviceInformation != null)))
            //{
            ...
            //    EventHandlerForDevice.controllerEventHandler.OnDeviceConnected = this.OnControllerConnected;
            //    EventHandlerForDevice.controllerEventHandler.OnDeviceClose = this.OnControllerClosing;
            //    EventHandlerForDevice.motorEventHandler.OnDeviceConnected = this.OnControllerConnected;
            //    EventHandlerForDevice.motorEventHandler.OnDeviceClose = this.OnControllerClosing;
            //}
            //else
            //{
        ...
        protected override void OnNavigatedFrom(NavigationEventArgs eventArgs)
        {
            ...
            if(EventHandlerForDevice.controllerEventHandler != null)
            {
               EventHandlerForDevice.controllerEventHandler.OnDeviceConnected = null;
               EventHandlerForDevice.controllerEventHandler.OnDeviceClose = null;
            }

            if(EventHandlerForDevice.motorEventHandler != null)
            {
                EventHandlerForDevice.motorEventHandler.OnDeviceConnected = null;
                EventHandlerForDevice.motorEventHandler.OnDeviceClose = null;
            }
        }
        ...
        private void DisconnectFromController_Click(Object sender, RoutedEventArgs eventArgs)
        {
            var selection = ConnectDevices.SelectedItems;
            DeviceListEntry entry = null;
            ...
            EventHandlerForDevice.controllerEventHandler.IsEnabledAutoReconnect = false;
            ...
            if (selection.Count > 0)
            {
                ...
                if (entry != null)
                {
                    EventHandlerForDevice.controllerEventHandler.CloseDevice();
                }
            }
        ...
        private async void OnDeviceEnumerationComplete(DeviceWatcher sender, Object args)
        {
            await rootPage.Dispatcher.RunAsync(
                ...
                new DispatchedHandler(() =>
                {
                    ...
                    if (EventHandlerForDevice.controllerEventHandler != null && EventHandlerForDevice.controllerEventHandler.IsDeviceConnected)
                    {
                        ...
                        rootPage.NotifyUser("Connected to CONTROLLER - " +
                                            EventHandlerForDevice.controllerEventHandler.DeviceInformation.Id, NotifyType.StatusMessage);

                        EventHandlerForDevice.controllerEventHandler.ConfigureCurrentlyConnectedDevice();
                    }
                    else if (EventHandlerForDevice.controllerEventHandler != null && EventHandlerForDevice.controllerEventHandler.IsEnabledAutoReconnect && EventHandlerForDevice.controllerEventHandler.DeviceInformation != null)
                    {
                        // We will be reconnecting to a device
                        ButtonDisconnectFromDevice.Content = ButtonNameDisableReconnectToDevice;

                        rootPage.NotifyUser("Waiting to reconnect to CONTROLLER device -  " + EventHandlerForDevice.controllerEventHandler.DeviceInformation.Id, NotifyType.StatusMessage);
                    }
                    else
                    {
                        rootPage.NotifyUser("No CONTROLLER device is currently connected", NotifyType.StatusMessage);
                    }
                }));
        }
